...
export type FileAssetModel = ModelStatic<any> & {
...
export default (
  ...
  FileAsset.associate = (models: any) => {
    ...
    models.FileAsset.belongsTo(models.User, {
      foreignKey: "uploadedByUserId",
      as: "uploadedBy",
    });
    models.FileAsset.hasMany(models.EntityAttachment, {
      foreignKey: "fileAssetId",
    });
  };
  return FileAsset;
};
