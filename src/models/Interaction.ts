...
export type InteractionModel = ModelStatic<any> & { associate?: (models: any) => void; };

export default (sequelize: Sequelize, dataTypes: typeof DataTypes): InteractionModel => {
  ...
  }, { tableName: "crm_interactions", timestamps: true, paranoid: true }) as InteractionModel;

  Interaction.associate = (models: any) => {
    models.Interaction.belongsTo(models.Business, { foreignKey: "businessId" });
    if(models.User) models.Interaction.belongsTo(models.User, { foreignKey: "userId" });
