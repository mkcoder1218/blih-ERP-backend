...
router.get(
  ...
  asyncHandler(ctrl.listPendingLatenessNotices),
);
router.post(
  "/lateness-notices/:id/approve",
  requireRole("HR_MANAGER", "BUSINESS_ADMIN"),
  asyncHandler(ctrl.approveLatenessNotice),
);
router.post(
  "/lateness-notices/:id/reject",
  requireRole("HR_MANAGER", "BUSINESS_ADMIN"),
  asyncHandler(ctrl.rejectLatenessNotice),
);
router.post(
  "/lateness-notices/:id/invalid",
  requireRole("HR_MANAGER", "BUSINESS_ADMIN"),
  asyncHandler(ctrl.markInvalidLatenessNotice),
);
router.patch(
  "/:id",
  requireAnyPermission("attendance.self", "attendance.manage"),
  asyncHandler(ctrl.updateMyWorkFromHome),
);
router.post(
  "/:id/approve",
  requireRole("HR_MANAGER", "BUSINESS_ADMIN"),
