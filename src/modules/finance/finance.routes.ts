...
import { BankExportController } from "./bankExport.controller";

const router = Router();
const controller = new FinanceController();
const deductionController = new SalaryDeductionController();
const bankExportController = new BankExportController();
...
// Bank salary export templates and generated payment instruction PDF.
router.get(
  "/employee-salaries/bank-templates",
  requireAnyPermission("salary_employee_read", "finance.manage"),
  asyncHandler(bankExportController.listTemplates),
);
router.post(
  "/employee-salaries/bank-templates",
  requireAnyPermission("finance.manage"),
  asyncHandler(bankExportController.createTemplate),
);
router.patch(
  "/employee-salaries/bank-templates/:templateId",
  requireAnyPermission("finance.manage"),
  asyncHandler(bankExportController.updateTemplate),
);
router.delete(
  "/employee-salaries/bank-templates/:templateId",
  requireAnyPermission("finance.manage"),
  asyncHandler(bankExportController.deleteTemplate),
);
router.post(
  "/employee-salaries/export-bank",
  requireAnyPermission("salary_employee_read", "finance.manage"),
  asyncHandler(bankExportController.exportBankDocument),
);
