...
exports.default = defineExitProcess;
function defineExitProcess(sequelize, dataTypes) {
    ...
    ExitProcess.associate = (models) => {
        ...
        ExitProcess.belongsTo(models.ExitReason, {
            foreignKey: "exitReasonId",
            as: "exitReason",
        });
        if (models.ExitClearanceStep) {
            ExitProcess.hasMany(models.ExitClearanceStep, {
                foreignKey: "exitProcessId",
                as: "clearanceSteps",
            });
        }
        if (models.ExitInterview) {
            ExitProcess.hasMany(models.ExitInterview, {
                foreignKey: "exitProcessId",
                as: "exitInterviews",
            });
        }
        if (models.ExitDocument) {
            ExitProcess.hasMany(models.ExitDocument, {
                foreignKey: "exitProcessId",
                as: "exitDocuments",
            });
        }
        if (models.User) {
            ...
            ExitProcess.belongsTo(models.User, {
                foreignKey: "offboardingFormSentByUserId",
                as: "offboardingFormSender",
            });
            ExitProcess.belongsTo(models.User, {
                foreignKey: "accountDisabledByUserId",
