...
exports.default = (sequelize, dataTypes) => {
    ...
    }, { tableName: "finance_expenses", timestamps: true, paranoid: true });
    Expense.associate = (models) => {
        models.Expense.belongsTo(models.Business, { foreignKey: "businessId" });
        if (models.User)
            models.Expense.belongsTo(models.User, { foreignKey: "requestedByUserId", as: "requester" });
        if (models.Department)
            models.Expense.belongsTo(models.Department, { foreignKey: "departmentId" });
        if (models.Project)
            models.Expense.belongsTo(models.Project, { foreignKey: "projectId" });
        if (models.FileAsset)
            models.Expense.belongsTo(models.FileAsset, { as: 'receipt', foreignKey: "receiptFileId" });
    };
    return Expense;
};
