 ...
 *         $ref: '#/components/responses/500'
 */
router.post('/', (0, permission_1.requirePermission)('department.create'), (0, validate_1.validate)(department_validator_1.createDepartmentSchema), (0, asyncHandler_1.asyncHandler)(controller.create));
/**
 * @openapi
 * /api/departments/{id}:
 *   patch:
 ...
 *         $ref: '#/components/responses/500'
 */
router.patch('/:id', (0, permission_1.requirePermission)('department.update'), (0, validate_1.validate)(department_validator_1.updateDepartmentSchema), (0, asyncHandler_1.asyncHandler)(controller.update));
/**
 * @openapi
 * /api/departments/{id}:
 *   delete:
 ...
 *         $ref: '#/components/responses/500'
 */
router.delete('/:id', (0, permission_1.requirePermission)('department.delete'), (0, asyncHandler_1.asyncHandler)(controller.remove));
