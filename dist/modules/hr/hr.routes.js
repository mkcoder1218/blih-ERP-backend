...
router.post("/records/:userId/return-contract", auth_1.authRequired, (0, permission_1.requireAnyPermission)("hr.write", "job.manage", "job.update"), (0, asyncHandler_1.asyncHandler)(controller.returnTerminatedEmployeeContract));
...
router.get("/performance/probation", auth_1.authRequired, (0, permission_1.requireAnyPermission)("performance.read", "performance.manage", "onboarding.read", "onboarding.manage"), (0, asyncHandler_1.asyncHandler)(perfController.probationDashboard));
router.put("/performance/probation/weights", auth_1.authRequired, (0, permission_1.requireAnyPermission)("performance.manage", "settings.update"), (0, asyncHandler_1.asyncHandler)(perfController.updateProbationWeights));
